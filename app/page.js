...
export default function Home() {
  return (
    <InteractiveBackground>
      <div className="flex flex-col items-center justify-center px-4 text-center select-none w-full max-w-4xl mx-auto">
        
        {/* Transparent Logo */}
        <div className="w-48 sm:w-56 flex justify-center items-center drop-shadow-sm mb-4">
          <Image
        ...
        {/* Badge */}
        <div className="px-5 py-1.5 rounded-full border-[1.5px] border-gray-600 mb-6">
